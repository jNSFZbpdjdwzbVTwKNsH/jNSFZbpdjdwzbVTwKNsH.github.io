...
l'endpoint __new_partecipant__ => l'evento avrà bisogno di una flag
...
Il loop è interrotto quanto arriva il segnale __end__.  
I segnali __inizio__, __end__ e __nuova_domanda__ potrebbero essere triggerati o
